        ...
        <div class="p-6 pb-4">
            ...
            <div class="mb-6">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="text-sm font-bold {getStatusColor(status)}">
                        {formatCurrency(currentAmount)} / {formatCurrency(
                            goalAmount,
                        )}
                    </span>
                </div>
            ...
            <div class="grid grid-cols-3 gap-4 mb-6">
                ...
                >
                    ...
                    <p class="text-xs text-blue-600 font-medium">Goal</p>
                ...
                >
                    ...
                    <p class="text-xs text-green-600 font-medium">Raised</p>
                ...
                >
                    ...
                    <p class="text-xs text-purple-600 font-medium">People</p>
        ...
        <div class="px-6 pb-6 relative z-30">
            <div class="grid grid-cols-2 gap-3">
                ...
                >
                    ...
                    <span class="font-medium text-sm">Contribute</span>
                </button>
                ...
                >
                    ...
                    <span class="font-medium text-sm">Add Expense</span>
                </button>
            </div>
