    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center flex-1 max-w-lg">
            <div class="relative w-full">
                <div class="relative {hasBeenActivated && isSearchFocused ? 'animate-activate-once' : ''}">
                    <input
                        type="text"
                    ...
                    {#if hasBeenActivated && isSearchFocused}
                        <div class="absolute inset-0 rounded-lg border-2 border-teal-400 opacity-0 animate-activate-border"></div>
                        <div class="absolute inset-0 rounded-lg bg-teal-100 opacity-0 animate-activate-glow"></div>
                    {/if}
                </div>
            </div>
        </div>
