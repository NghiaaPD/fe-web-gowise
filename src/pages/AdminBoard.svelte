    ...
    <div class="p-6">
        {#if activeTab === "overview"}
            ...
            >
                ...
                >
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <span class="text-sm text-green-600 font-medium"
                            >+{stats.totalUsers.change}% from last month</span
                        >
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <span class="text-sm text-green-600 font-medium"
                            >+{stats.activeUsers.change}% from last week</span
                        >
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <span class="text-sm text-green-600 font-medium"
                            >+{stats.totalPlans.change}% from last month</span
                        >
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <span class="text-sm text-green-600 font-medium"
                            >+{stats.revenue.change}% conversion</span
                        >
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <div
                    class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6"
                >
                    <!-- Server Status -->
                    <div class="text-center">
                        ...
                        <p class="text-xs text-gray-600 mb-1">Server Status</p>
                        <p
                            class="text-sm font-semibold {systemHealth
                                .serverStatus.color}"
                        >
                    ...
                    <div class="text-center">
                        ...
                        <p
                            class="text-sm font-semibold {systemHealth.uptime
                                .color}"
                        >
                    ...
                    <div class="text-center">
                        ...
                        <p
                            class="text-sm font-semibold {systemHealth.cpuUsage
                                .color}"
                        >
                    ...
                    <div class="text-center">
                        ...
                        <p
                            class="text-sm font-semibold {systemHealth.memory
                                .color}"
                        >
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-xs text-gray-600 mb-1">Disk Usage</p>
                        <p
                            class="text-sm font-semibold {systemHealth.diskUsage
                                .color}"
                        >
        ...
        {:else}
            ...
            >
                ...
                <p class="text-gray-600">
                    This section is under development. Content for {activeTab} management
